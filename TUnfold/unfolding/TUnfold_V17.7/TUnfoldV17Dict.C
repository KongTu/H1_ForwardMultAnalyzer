...
namespace ROOT {
   ...
   static TGenericClassInfo *GenerateInitInstanceLocal(const ::TUnfoldV17*)
   {
      ...
      static ::ROOT::TGenericClassInfo 
         instance("TUnfoldV17", ::TUnfoldV17::Class_Version(), "TUnfold.h", 106,
...
namespace ROOT {
   ...
   static TGenericClassInfo *GenerateInitInstanceLocal(const ::TUnfoldSysV17*)
   {
      ...
      static ::ROOT::TGenericClassInfo 
         instance("TUnfoldSysV17", ::TUnfoldSysV17::Class_Version(), "TUnfoldSys.h", 58,
...
namespace ROOT {
   ...
   static TGenericClassInfo *GenerateInitInstanceLocal(const ::TUnfoldBinningV17*)
   {
      ...
      static ::ROOT::TGenericClassInfo 
         instance("TUnfoldBinningV17", ::TUnfoldBinningV17::Class_Version(), "TUnfoldBinning.h", 57,
...
namespace ROOT {
   ...
   static TGenericClassInfo *GenerateInitInstanceLocal(const ::TUnfoldDensityV17*)
   {
      ...
      static ::ROOT::TGenericClassInfo 
         instance("TUnfoldDensityV17", ::TUnfoldDensityV17::Class_Version(), "", 56,
...
namespace ROOT {
   ...
   static TGenericClassInfo *GenerateInitInstanceLocal(const ::TUnfoldBinningXMLV17*)
   {
      ...
      static ::ROOT::TGenericClassInfo 
         instance("TUnfoldBinningXMLV17", ::TUnfoldBinningXMLV17::Class_Version(), "", 270,
...
class __attribute__((annotate(R"ATTRDUMP(Unfolding with support for L-curve analysis)ATTRDUMP"))) __attribute__((annotate("$clingAutoload$TUnfold.h")))  __attribute__((annotate("$clingAutoload$TUnfoldSys.h")))  TUnfoldV17;
...
class TUnfoldDensityV17 : public TUnfoldSysV17 {
 ...
 public:
   ...
   TH2 *GetTransferMatrix(const char *histogramName,
                          const char *histogramTitle=0,Bool_t useAxisBinning=kTRUE) const; // get transfer matrix
