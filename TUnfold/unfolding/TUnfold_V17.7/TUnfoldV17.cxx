...
///  transfer matrix connecting the output and input data.
///   The bin contents are overwritten for those bins where dxdy is non-zero.

void TUnfoldV17::GetTransferMatrix(TH2 *dxdy) const
{
   // retreive transfer matrix (matrix connecting input and output)
